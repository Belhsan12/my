...
<div className="text-center">
  ...
  {showSuccessMessage && (
    <Alert variant="success" className="mx-auto mt-2 text-center">
      <strong>Your message has been successfully sent. Thank you for reaching out to me! If you have any urgent inquiries, feel free to call me at +216 52942810</strong>
    </Alert>
  )}
</form>
